              ...
              <div className="blog-item hoverstyle">
                <figure>
                  <img
                    alt="img"
                    className="w-100"
                    src="https://res.cloudinary.com/denlhej9f/image/upload/v1694589864/WhatsApp_Image_2023-09-13_at_11.53.14_AM_y6gsw1.jpg"
                  />
                </figure>
                <p className="p-30">
          ...
          <div className="row">
            ...
            <div className="col-md-4 mb-4">
              <div className="card">
                <div style={{ textAlign: "center" }}>
                  <img
                    src="https://res.cloudinary.com/denlhej9f/image/upload/v1694605118/logo_pcsigf.png"
                    alt="Logo Design"
            ...
            <div className="col-md-4 mb-4">
              <div className="card">
                <div style={{ textAlign: "center" }}>
                  <img
                    src="https://res.cloudinary.com/denlhej9f/image/upload/v1694590592/business-cards_zkose8.png"
                    alt="Business Cards"
                    className="card-img-top"
                    style={{ width: "50px", height: "50px" }}
                  />
            ...
            <div className="col-md-4 mb-4">
              <div className="card">
                <div style={{ textAlign: "center" }}>
                  <img
                    src="https://res.cloudinary.com/denlhej9f/image/upload/v1694590592/brochure_t5zgq1.png"
            ...
            <div className="col-md-4 mb-4">
              <div className="card">
                <div style={{ textAlign: "center" }}>
                  <img
                    src="https://res.cloudinary.com/denlhej9f/image/upload/v1694605118/online-advertising_d4e9pm.png"
                    alt="Brochures and Flyers"
                    className="card-img-top"
                    style={{ width: "50px", height: "50px" }}
                  />
            ...
            <div className="col-md-4 mb-4">
              <div className="card">
                <div style={{ textAlign: "center" }}>
                  <img
                    src="https://res.cloudinary.com/denlhej9f/image/upload/v1694605118/digital-drawing_svk8kz.png"
                    alt="Brochures and Flyers"
                    className="card-img-top"
                    style={{ width: "50px", height: "50px" }}
                  />
            ...
            <div className="col-md-4 mb-4">
              <div className="card">
                <div style={{ textAlign: "center" }}>
                  <img
                    src="https://res.cloudinary.com/denlhej9f/image/upload/v1694605118/social-media_1_hs4wxa.png"
                    alt="Brochures and Flyers"
                    className="card-img-top"
                    style={{ width: "50px", height: "50px" }}
                  />
            ...
            <div className="col-md-4 mb-4">
              <div className="card">
                <div style={{ textAlign: "center" }}>
                  <img
                    src="https://res.cloudinary.com/denlhej9f/image/upload/v1694590592/pen-tablet_taejzv.png"
                    alt="Brochures and Flyers"
                    className="card-img-top"
                    style={{ width: "50px", height: "50px" }}
                  />
            ...
            <div className="col-md-4 mb-4">
              <div className="card">
                <div style={{ textAlign: "center" }}>
                  <img
                    src="https://res.cloudinary.com/denlhej9f/image/upload/v1694605118/presentation_m1zk0p.png"
                    alt="Brochures and Flyers"
                    className="card-img-top"
                    style={{ width: "50px", height: "50px" }}
                  />
