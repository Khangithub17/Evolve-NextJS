          ...
          <div className="row">
            ...
            <div className="col-xl-6 pl-75">
              ...
              <div className="welcome-text">
                ...
                <p className="pt-4 pb-5">
                At our firm, we believe in the power transparency and time-efficiency. We strive to maintain open lines of communication with our clients throughout the entire process, from the initial consultation to the final deliverables. In today’s world as technology is constantly evolving and consumer behaviour shifts, 
                We takes pride in staying up-to-date with the latest industry trends and best practices to ensure that our clients receive the highest quality services.
                </p>
                <p className="pt-4 pb-5">
                Whether a small start-up or a large corporation, our firm has the expertise and resources to help you succeed. We are committed to delivering innovative and effective marketing solutions that drive results and exceed expectations. We look forward to the opportunity to work with you and help your business thrive.
                </p>
            ...
            <div className="row">
              <div className="col-xl-4 col-lg-6">
                <div className="makes-us-different-text">
                  ...
                  <p>
                  Performance development is a comprehensive approach aimed at enhancing the skills, capabilities, 
                  and productivity of individuals and teams within an organization. It is a dynamic process that goes 
                  beyond traditional performance management by focusing on continuous growth.
              ...
              <div className="col-xl-4 col-lg-6">
                <div className="makes-us-different-text">
                  ...
                  <p>
                  Creative concepts and ideas are the lifeblood of innovation, artistry, and problem-solving. They are the spark that ignites new possibilities,
                  transforms industries, and shapes the world around us. Whether you're an artist, an entrepreneur, a designer, or simply someone seek.
                  </p>
                </div>
              </div>
              <div className="col-xl-4 col-lg-6">
              ...
              C45.536,53.38,44.077,54.266,42.56,55.029z"
                  ...
                  <h4>Branding</h4>
                  <p>
                  Branding is far more than just a logo or a catchy slogan; it's the essence of your business the soul that defines who you are, what you stand for, and how you're perceived by the world. 
                  It's the art and science of creating a unique and compelling identity that resonates with your audience and builds trust.
                  </p>
                </div>
              </div>
              <div className="col-xl-4 col-lg-6">
                <div className="makes-us-different-text">
                  ...
                  <h4>E-commerce</h4>
                  <p>
                  E-commerce, short for electronic commerce, has become a transformative force in the global marketplace. It encompasses the buying and selling of goods and services through online platforms, 
                  reshaping the way consumers shop and businesses operate. With its convenience, accessibility, and endless opportunities.
                  </p>
                </div>
              </div>
              <div className="col-xl-4 col-lg-6">
                <div className="makes-us-different-text">
                  ...
                  <p>
                  User Experience (UX) and User Interface (UI) design and analysis are integral components of digital product development, playing a pivotal role in creating engaging, intuitive, and visually appealing user interfaces. These disciplines are dedicated to understanding user behavior, 
                  needs.
                  </p>
                </div>
              </div>
              <div className="col-xl-4 col-lg-6">
                <div className="makes-us-different-text">
                  ...
                  <p>
                  Development agencies excel in crafting bespoke solutions that align with clients' specific goals and requirements.
                  This customization ensures that digital assets effectively address the unique challenges and opportunities each client faces This versatility ensures that the solutions are scalable, secure, and future-proof.
                  </p>
                </div>
              </div>
            </div>
